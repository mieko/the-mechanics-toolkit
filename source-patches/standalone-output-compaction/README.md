...
`3d2ee51ca2d5db578f328aa75e20aa22c0197c9a`. That is the CLI bundled with Codex Desktop
`26.903.61454` (build `8378`). The source-patch command verifies the exact commit and every target
