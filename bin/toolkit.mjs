...
const patchScripts = new Map([
  ...
  ["native-app-tools-peer-authorization", "patches/native-app-tools-peer-authorization/patch.mjs"],
  ...
  ["tinrelay-pointer-presentation", "patches/tinrelay-pointer-presentation/patch.mjs"],
