...
if (!build7345 && !build7746 && !build7942 && !build8109 && !build8378) assert.equal(count(source, "i=_s(uW,r)"), 1, "shortcut dispatch reads configured accelerators");
assert.equal(
...
process.stdout.write(`${JSON.stringify({
  ...
  terminalFocused: build7746 || build7942 || build8109 || build8378 ? "stock-terminal-toggle-action" : "hides-bottom-panel-and-focuses-composer",
