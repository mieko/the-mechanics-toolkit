...
function inspectState() {
  ...
  if (markers.slice(0, 4).every(Boolean) &&
      ((source.includes('content:"RED ALERT"') &&
       ...
       (source.includes('content:"BAD MODEL"') &&
        (source.includes("version:3") || source.includes("version:4") || source.includes("version:5"))))) {
